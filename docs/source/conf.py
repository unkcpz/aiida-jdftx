# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-jdftx
#
...
project = u'aiida-jdftx'
copyright_first_year = '2020'
copyright_owners = 'Jason Yu'
...
release = aiida_jdftx.__version__
...
html_use_opensearch = 'http://aiida-jdftx.readthedocs.io'
...
htmlhelp_basename = 'aiida-jdftx-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_jdftx')
