...
Check version number in setup.json and aiida_jdftx/__init__.py and make sure
they match.
"""
# -*- coding: utf-8 -*-
...
import aiida_jdftx  # pylint: disable=wrong-import-position
VERSION = aiida_jdftx.__version__
